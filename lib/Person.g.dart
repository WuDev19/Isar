...
const PersonSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'status': PropertySchema(
      ...
      name: r'status',
      type: IsarType.byte,
      enumMap: _PersonstatusEnumValueMap,
    ),
  },
...
Person _personDeserialize(
  ...
  final object = Person();
  object.address =
      reader.readObjectOrNull<Address>(
        offsets[0],
  ...
  object.status =
      _PersonstatusValueEnumMap[reader.readByteOrNull(offsets[3])] ??
      Status.died;
  return object;
}
...
P _personDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 3:
      return (_PersonstatusValueEnumMap[reader.readByteOrNull(offset)] ??
              Status.died)
          as P;
    default:
...
const _PersonstatusEnumValueMap = {'died': 0, 'alive': 1};
const _PersonstatusValueEnumMap = {0: Status.died, 1: Status.alive};
...
extension PersonQueryObject on QueryBuilder<Person, Person, QFilterCondition> {
  QueryBuilder<Person, Person, QAfterFilterCondition> address(
...
extension PersonQueryProperty on QueryBuilder<Person, Person, QQueryProperty> {
  ...
  QueryBuilder<Person, Address, QQueryOperations> addressProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Status, QQueryOperations> statusProperty() {
    return QueryBuilder.apply(this, (query) {
